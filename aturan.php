...
<?php endif; ?>
    ...
    <section class="rules-header">
        <h1>Aturan Hunian Kinara</h1>
        <p class="text-muted">Demi kenyamanan dan ketenangan bersama di Kinara Kost.</p>
    </section>
...
<div class="rules-container">
    <div class="rules-grid">
        ...
        while($row = mysqli_fetch_assoc($q_aturan)):
            // Memecah deskripsi berdasarkan baris baru menjadi array
        ...
        <div class="rule-card">
            ...
            <h3><?= $row['kategori']; ?></h3>
            <ul>
                <?php foreach($list_aturan as $item): if(trim($item) != ""): ?>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('click', (e) => {
        ...
        if (targetWrapper) {
            // Jika yang diklik adalah Trigger (Tombol/Menu/Halo Wira)
